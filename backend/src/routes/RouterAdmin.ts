...
import {SchemasAdminCreate, SchemasAdminRegister}  from "../middleware/validator/schemas/SchemasAdmin";
...
router.post('/create', jsonParser, async (req: Request, res: Response) => {
    ...
    */
    try {
        const validate = SchemasAdminCreate.parse(req.body);
...
router.patch('/register', jsonParser, async (req: Request, res: Response) => {
    ...
    */
    try {
        const validate = SchemasAdminRegister.parse(req.body);
